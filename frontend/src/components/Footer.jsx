        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 bg-[#F6A500] rounded-lg flex items-center justify-center mr-3">
                <span className="text-white text-2xl font-bold">Д</span>
              </div>
              <div>
              ...
              {[
                ...
                <li key={link.id}>
                  <button
                    ...
                    className="text-gray-400 hover:text-[#F6A500] transition-colors duration-200 text-sm"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#F6A500] flex-shrink-0 mt-0.5" />
                <span className="text-sm text-gray-400">{SCHOOL_INFO.address}</span>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-[#F6A500] flex-shrink-0 mt-0.5" />
                <a
                  href={`tel:${SCHOOL_INFO.phone}`}
                  className="text-sm text-gray-400 hover:text-[#F6A500] transition-colors"
                >
                  {SCHOOL_INFO.phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-[#F6A500] flex-shrink-0 mt-0.5" />
                <a
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              <a
                ...
                className="w-12 h-12 bg-white/10 hover:bg-[#F6A500] rounded-lg flex items-center justify-center transition-colors duration-300"
                aria-label="VK"
              >
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Пн-Пт: 09:00 - 20:00</p>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-400">
              <span>Сделано с</span>
              <Heart className="w-4 h-4 fill-[#F6A500] text-[#F6A500]" />
