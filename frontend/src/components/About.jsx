      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            <div className="absolute -inset-4 bg-gradient-to-r from-[#F6A500]/20 to-[#0E2A47]/20 rounded-2xl blur-2xl group-hover:blur-3xl transition-all duration-300"></div>
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0E2A47]/50 to-transparent"></div>
            </div>
