...
},
{
  ...
  description: "97% наших выпускников поступают в ведущие вузы страны",
  icon: "trophy"
},
{
  id: 4,
...
export const TEACHERS = [
{
  ...
  subject: "Математика",
  bio: "«Математика — это не просто цифры, это способ мышления и ключ к успеху»",
  motto: "",
  image: null
},
{
  ...
  subject: "Физика",
  bio: "«Делаю физику понятной и увлекательной для каждого ученика»",
  motto: "",
  image: null
},
{
  ...
  bio: "«Раскрываю потенциал через технологии и языки — готовлю к глобальному будущему»",
  motto: "",
  image: null
},
{
  ...
  bio: "«Тот первый учитель, которого дети вспоминают с теплом всю жизнь»",
  motto: "",
  image: null
},
{
  ...
  subject: "Начальная школа",
  bio: "«Создаю атмосферу, где каждый ребёнок чувствует себя особенным»",
  motto: "",
  image: null
}];
