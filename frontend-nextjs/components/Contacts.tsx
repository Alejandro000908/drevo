                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-[#25D366] hover:underline mt-1 inline-block"
                    >
                      WhatsApp
                    </a>
                  </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            >
              ...
              <Button
                ...
                className="w-full bg-[#009479] hover:bg-[#007A64] text-white font-semibold py-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  'Отправка...'
                ) : (
